const PHASES = [
	{
		...
		description:
			"We take ownership of the full development process, ensuring the project is built correctly from both an operational and commercial perspective.",
		areas: [
			{
			...
			},
			{
				...
				items: [
					...
					"Systems setup, Reporting, payments, operations",
				],
			},
		],
	},
	{
		...
		description:
			"Before opening, we build the organization and structure needed to run the hotel efficiently with minimal owner involvement.",
		areas: [
			{
				label: "Scope",
				items: [
	...
	},
	{
		...
		description:
			"We take a leading, high-level role in ensuring the hotel performs financially and operationally, esigned to minimize owner involvement while maintaining full control and transparency.",
		areas: [
			{
			...
			},
			{
				...
				items: ["Monthly reporting", "Budget tracking and cost control"],
			},
			{
	...
	},
	{
		...
		description:
			"If the goal is to sell or reposition the asset, we prepare the business accordingly to maximize valuation.",
		optional: true,
		areas: [
			{
				label: "Scope",
		...
		<div className="max-w-3xl mx-auto px-4 py-8 md:px-8 md:py-12">
			...
			<div className="mb-12 pb-10 border-b border-neutral-200">
				...
				<p className="text-base text-neutral-700 leading-relaxed">
					We support hotel projects from early-stage concept all the way through
					operation and eventual exit. The goal is to create a well-structured,
					high-performing asset that can run efficiently and maximize long-term
					value.
				</p>
				<p className="text-base text-neutral-700 leading-relaxed mt-3">
					For your Ubud project (30, 34 rooms depending on final strategy), we
					can take a leading role across both development and operations.
				</p>
			</div>
				...
				{PHASES.map((phase) => (
					<section key={phase.number}>
						<div className="flex items-baseline gap-4 mb-2">
							...
							{phase.optional && (
								<span className="text-xs text-neutral-700 bg-neutral-100 border border-neutral-200 rounded px-2 py-0.5">
									Optional
								</span>
							)}
						</div>
						<p className="text-sm text-neutral-700 leading-relaxed mb-6 ml-10">
							{phase.description}
						</p>
